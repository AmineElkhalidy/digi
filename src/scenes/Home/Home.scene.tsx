  ...
  return (
    <>
      ...
      <section id="features" className="bg-gray-100 py-16">
        <div className="max-w-screen-xl mx-auto px-6 xl:px-0 grid md:grid-cols-2 items-center gap-8 md:gap-16">
          <div>
      ...
      <section id="trusted-by" className="max-w-5xl mx-auto py-28 px-6 lg:px-0">
